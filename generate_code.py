...
def generate_code_script():
    ...
    def clean_response(text: str) -> str:
        ...
        If the detected code block is empty, the raw response is returned so
        potential error messages aren't lost.
        """
        if "```" in text:
            # Find the last fenced block, accepting any optional language tag
